...
<template>
  <div class="flex flex-col h-screen leading-normal tracking-normal">
    <div class="navbar bg-green-800 text-white">
      ...
      <div class="navbar-end">
        ...
        <div class="dropdown dropdown-end">
          ...
          <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-blue-900 shadow">
            <div class="card-body">
    ...
    <div class="flex-l overflow-y-auto p-5">
      <RouterView />
    </div>

    <footer class="absolute bottom-0 footer items-center p-4 bg-green-950 text-primary-content">
